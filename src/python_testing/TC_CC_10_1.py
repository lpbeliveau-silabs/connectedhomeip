...
class TC_CC_10_1(MatterBaseTest):
    ...
    def _prepare_cc_extension_field_set(self, attribute_value_list: List[Clusters.ScenesManagement.Structs.AttributeValuePairStruct]) -> Clusters.ScenesManagement.Structs.ExtensionFieldSet:
        ...
        # Create the ExtensionFieldSetStruct with the cluster_id and the filtered list of AttributeValueStructs
        extension_field_set = Clusters.ScenesManagement.Structs.ExtensionFieldSetStruct(
            cluster_id=Clusters.Objects.ColorControl.id,
    ...
    async def test_TC_CC_10_1(self):
        ...
        if self.pics_guard(self.check_pics("CC.S.C06.Rsp")):
            ...
            asserts.assert_greater_equal(result[1][cluster][attributes.CurrentHue], 170, "CurrentHue is not greater than or equal to 170")
        ...
        if self.pics_guard(self.check_pics("CC.S.C07.Rsp")):
            ...
            asserts.assert_greater_equal(result[1][cluster][attributes.CurrentX], 31000, "CurrentX is not greater than or equal to 31000")
            asserts.assert_less_equal(result[1][cluster][attributes.CurrentY], 21000, "CurrentY is not less than or equal to 21000")
            asserts.assert_greater_equal(result[1][cluster][attributes.CurrentY], 17000, "CurrentY is not greater than or equal to 17000")
        ...
        if self.pics_guard(self.check_pics("CC.S.C0a.Rsp")):
            ...
            asserts.assert_less_equal(result[1][cluster][attributes.ColorTemperatureMireds], ColorTempPhysicalMaxMiredsValue, "ColorTemperatureMireds is not less than or equal to ColorTempPhysicalMaxMireds")
            asserts.assert_greater_equal(result[1][cluster][attributes.ColorTemperatureMireds], ColorTempPhysicalMinMiredsValue, "ColorTemperatureMireds is not greater than or equal to ColorTempPhysicalMinMireds")
        ...
        if self.pics_guard(self.check_pics("CC.S.C43.Rsp")):
            ...
            asserts.assert_less_equal(result[1][cluster][attributes.EnhancedCurrentHue], 21800, "EnhancedCurrentHue is not less than or equal to 21800")
            asserts.assert_greater_equal(result[1][cluster][attributes.EnhancedCurrentHue], 18200, "EnhancedCurrentHue is not greater than or equal to 18200")
            asserts.assert_less_equal(result[1][cluster][attributes.CurrentSaturation], 58, "CurrentSaturation is not 58")
            asserts.assert_greater_equal(result[1][cluster][attributes.CurrentSaturation], 42, "CurrentSaturation is not 42")
            ...
            if EFS.clusterID == 0x0300:
                for AV in EFS.attributeValueList:
                    ...
                    if AV.attributeID == 0x0007 and self.pics_guard(self.check_pics("CC.S.C0a.Rsp")):
                        asserts.assert_less_equal(AV.valueUnsigned16, ColorTempPhysicalMaxMiredsValue, "View Scene failed on ColorTemperatureMireds above limit")
                        asserts.assert_greater_equal(AV.valueUnsigned16, ColorTempPhysicalMinMiredsValue, "View Scene failed on ColorTemperatureMireds below limit")
                ...
                Clusters.ScenesManagement.Commands.AddScene(
                    ...
                    [
                        ...
                        [
                            ...
                            Clusters.ScenesManagement.Structs.AttributeValuePairStruct(attributeID=0x0003, valueUnsigned16=16334),
                            Clusters.ScenesManagement.Structs.AttributeValuePairStruct(attributeID=0x0004, valueUnsigned16=13067)
                            ]
                        )
                    ]
        ...
        if self.pics_guard(self.check_pics("CC.S.C0a.Rsp")):
            result = await self.TH1.ReadAttribute(self.dut_node_id, [(1, attributes.ColorTemperatureMireds)])
            asserts.assert_less_equal(result[1][cluster][attributes.ColorTemperatureMireds], ColorTempPhysicalMaxMiredsValue, "ColorTemperatureMireds is above limit")
            asserts.assert_greater_equal(result[1][cluster][attributes.ColorTemperatureMireds], ColorTempPhysicalMinMiredsValue, "ColorTemperatureMireds is below limit")
                ...
                Clusters.ScenesManagement.Commands.AddScene(
                    ...
                    [
                        ...
                        [
                            ...
                            Clusters.ScenesManagement.Structs.AttributeValuePairStruct(attributeID=0x4000, valueUnsigned16=12000),
                            Clusters.ScenesManagement.Structs.AttributeValuePairStruct(attributeID=0x0001, valueUnsigned16=70)
                            ]
                        )
                    ]
        ...
        if self.pics_guard(self.check_pics("CC.S.C43.Rsp")):
            ...
            asserts.assert_greater_equal(result[1][cluster][attributes.EnhancedCurrentHue], 10200, "EnhancedCurrentHue is below limit")
