...
@click.option(
    '--water-heater-manager-app', type=ExistingFilePath, cls=DeprecatedOption, replacement='--app-path water-heater-manager:<path>',
    help='what water-heater-manager app to use')
@click.option(
...
def cmd_run(context: click.Context, dry_run: bool, iterations: int,
            ...
            water_heater_manager_app: Path | None, evse_app: Path | None, closure_app: Path | None, matter_repl_yaml_tester: Path | None,
    ...
    handle_deprecated_pathopt('water-heater-manager', water_heater_manager_app, SubprocessKind.APP)
