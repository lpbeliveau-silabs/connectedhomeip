...
def BuildHostTarget():
    ...
    app_parts = [
        ...
        TargetPart('water-heater-manager', app=HostApp.WATER_HEATER_MANAGER),
...
def BuildEsp32Target():
    ...
    target.AppendFixedTargets([
        ...
        TargetPart('water-heater-manager', app=Esp32App.WATER_HEATER_MANAGER),
...
def BuildEfr32Target():
    ...
    target.AppendFixedTargets([
        ...
        TargetPart('water-heater-manager', app=Efr32App.WATER_HEATER_MANAGER),
