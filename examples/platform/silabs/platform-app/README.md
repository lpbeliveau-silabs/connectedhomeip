...
*   Build the example application:
          ...
          cd ~/connectedhomeip
          ./scripts/examples/gn_silabs_example.sh examples/platform/silabs/platform-app/ ./out/platform-app BRD4187C
...
-   To delete generated executable, libraries and object files use:
    ...
    OR use GN/Ninja directly
          ...
          $ cd ~/connectedhomeip/examples/platform/silabs/platform-app/
...
*   Build the example as Intermittently Connected Device (ICD)
          ...
          $ ./scripts/examples/gn_silabs_example.sh ./examples/platform/silabs/platform-app/ ./out/platform-app_ICD BRD4187C --icd
...
*   Build the example with pigweed RPC
          ...
          $ ./scripts/examples/gn_silabs_example.sh examples/platform/silabs/platform-app/ out/platform_app_rpc BRD4187C 'import("//with_pw_rpc.gni")'
...
`chip_progress_logging, chip_detail_logging, chip_automation_logging`
    ...
    $ ./scripts/examples/gn_silabs_example.sh ./examples/platform/silabs/platform-app/ ./out/platform-app BRD4164A "chip_detail_logging=false chip_automation_logging=false chip_progress_logging=false"

### Debug build / release build

`is_debug`

    $ ./scripts/examples/gn_silabs_example.sh ./examples/platform/silabs/platform-app/ ./out/platform-app BRD4164A "is_debug=false"

### Disabling LCD

`show_qr_code`

    $ ./scripts/examples/gn_silabs_example.sh ./examples/platform/silabs/platform-app/ ./out/platform-app BRD4164A "show_qr_code=false"
...
`kvs_max_entries`
    ...
    $ ./scripts/examples/gn_silabs_example.sh ./examples/platform/silabs/platform-app/ ./out/platform-app BRD4164A kvs_max_entries=50
