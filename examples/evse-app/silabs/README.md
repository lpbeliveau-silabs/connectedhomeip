...
The EFR32 EVSE example provides a baseline demonstration of a EVSE device, built
using Matter and the Silicon Labs gecko SDK. It can be controlled by a Chip
controller over an Openthread or Wifi network.
...
With this EVSE example you can also use group communication to send EVSE
