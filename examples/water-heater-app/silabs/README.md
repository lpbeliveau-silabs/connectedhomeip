...
- [Matter EFR32 Water Heater Example](#matter-efr32-water-heater-example)
...
The EFR32 Water Heater example provides a baseline demonstration of a Water
Heater device, built using Matter and the Silicon Labs gecko SDK. It can be
...
The Water Heater example is intended to serve both as a means to explore the
workings of Matter Water Heater as well as a template for creating real products
...
* Build the example application:
                    ...
                    cd ~/connectedhomeip
                    ./scripts/examples/gn_silabs_example.sh ./examples/water-heater-app/silabs/ ./out/water-heater-app BRD4187C
...
- To delete generated executable, libraries and object files use:
    ...
    OR use GN/Ninja directly
                    ...
                    $ cd ~/connectedhomeip/examples/water-heater-app/silabs
                    $ git submodule update --init
                    $ source third_party/connectedhomeip/scripts/activate.sh
                    $ export SILABS_BOARD=BRD4187C

    To build the Water Heater example
...
* Build the example as Intermittently Connected Device (ICD)
                    ...
                    $ ./scripts/examples/gn_silabs_example.sh ./examples/water-heater-app/silabs/ ./out/water-heater-app_ICD BRD4187C --icd

* Build the example with pigweed RPC

                    $ ./scripts/examples/gn_silabs_example.sh examples/water-heater-app/silabs/ out/water_heater_app_rpc BRD4187C 'import("//with_pw_rpc.gni")'
...
- On the command line:
                    ...
                    $ cd ~/connectedhomeip/examples/water-heater-app/silabs
                    $ python3 out/debug/matter-silabs-water-heater-example.flash.py
...
With this Water Heaterexample you can also use group communication to send Water
Heater commands to multiples devices at once. Please refer to the
...
`chip_progress_logging, chip_detail_logging, chip_automation_logging`
    ...
    $ ./scripts/examples/gn_silabs_example.sh ./examples/water-heater-app/silabs ./out/water-heater-app BRD4164A "chip_detail_logging=false chip_automation_logging=false chip_progress_logging=false"

### Debug build / release build

`is_debug`

    $ ./scripts/examples/gn_silabs_example.sh ./examples/water-heater-app/silabs ./out/water-heater-app BRD4164A "is_debug=false"

### Disabling LCD

`show_qr_code`

    $ ./scripts/examples/gn_silabs_example.sh ./examples/water-heater-app/silabs ./out/water-heater-app BRD4164A "show_qr_code=false"
...
`kvs_max_entries`
    ...
    $ ./scripts/examples/gn_silabs_example.sh ./examples/water-heater-app/silabs ./out/water-heater-app BRD4164A kvs_max_entries=50
