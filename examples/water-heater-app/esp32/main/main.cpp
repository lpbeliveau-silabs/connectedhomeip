...
{
    ESP_LOGD(TAG, "Water Heater App: ApplicationInit()");
    WaterHeaterApplicationInit();
}

void ApplicationShutdown()
{
    ESP_LOGD(TAG, "Water Heater App: ApplicationShutdown()");
...
extern "C" void app_main()
{
    ...
    ESP_LOGI(TAG, "==================================================");
    ESP_LOGI(TAG, "chip-esp32-water-heater-app starting. featureMap 0x%08lx", DeviceEnergyManagement::sFeatureMap.Raw());
    ESP_LOGI(TAG, "==================================================");
