...
- Running
    ...
    - Run Linux Water Heater Example App
              ...
              $ cd ~/connectedhomeip/examples/water-heater-app/linux
              $ sudo out/debug/chip-whm-app --ble-controller [bluetooth controller number]
              # In this example, the device we want to use is hci1
              $ sudo out/debug/chip-whm-app --ble-controller 1
...
1. Run the Water Heater application:
    ...
    ```
    rm /tmp/chip_* && ./out/debug/chip-whm-app --trace-to json:log --enable-key 000102030405060708090a0b0c0d0e0f
    ```
